...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col">
				<div class="judull">
					<?php foreach ($tandawaktu2 as $tandawaktu): ?>
				...
				<div class="wilayah">
					<ul class="nav nav-pills" style="margin-top: 30px;">
						...
						<li class="nav-item">
							<a class="nav-link active" href="<?php echo site_url('gempa/tandaterbitslm') ?>" style="background-color: #007bff;">
							Sleman</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="<?php echo site_url('gempa/tandaterbitbtl') ?>">
							Bantul</a>
						</li>
						<li class="nav-item">
