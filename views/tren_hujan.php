...
<html lang="en">
	...
	<body>
		<div class="breadcrumbs breadcrumbs-light">
			<div class="container">
				<h1 class="pull-left">Tren Curah Hujan</h1>
			</div>
		</div>
		<div class="container">
			<div class="row">
				<div class="col">
					<?php foreach ($curah as $curah){ ?>
						<img class="myImg" src="<?php echo base_url()."../File_BMKG/Iklim/Perubahan_iklim/Tren_curah_hujan/".$curah->gambar;?>" style="max-width: 100%;margin: 10px 0 10px 0;" onclick="onClick(this)">
						<p><?php echo $curah->teks ?> </p>
					<?php } ?>
				</div>
				<div class="col-5">
					<h5>Berita</h5>
