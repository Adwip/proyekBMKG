	...
	<div class="container">
		<ul class="nav nav-pills" style="margin-top: 30px;">
			<li class="nav-item">
				...
				<li class="nav-item">
					<a class="nav-link" href="<?php echo site_url('cuaca/prakiraan_cuaca_bsk') ?>">
						<?php
					...
					<li class="nav-item">
						<a class="nav-link active" href="<?php echo site_url('cuaca/prakiraan_cuaca_ls') ?>" style="background-color: #007bff;"><?php
