...
<html lang="en">
	...
	<body>
		<div class="breadcrumbs breadcrumbs-light">
			<div class="container">
				<h1 class="pull-left">Prospek Cuaca Mingguan</h1>
			</div>
		</div>
		<div class="container">
			<div class="row">
				<div class="col">
					<?php foreach ($prospek as $prospek) {
					?>
						<embed src="<?php echo base_url()."../File_BMKG/Iklim/Cuaca_mingguan/".$prospek->PDF; ?>" style="width:600px;height:1000px"></embed>
					<?php
					}
					?>
				</div>
