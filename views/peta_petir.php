...
<html lang="en">
	...
	<body>
		<div class="breadcrumbs breadcrumbs-light">
			<div class="container">
				<h1 class="pull-left">Peta Sambaran Petir</h1>
			</div>
		</div>
		<div class="container">
			<div class="row">
				...
				?>
				<h3 class="sub-judul" style="margin-top: 20px;">Peta Sambaran Petir Bulan <?php echo $monList[$bulan].$year ?></h3>
					<?php foreach($sam_petir as $sam_petir) { ?>
						<img class="myImg" src="<?php echo base_url()."../File_BMKG/Gempa/peta_sambaran/".$sam_petir->foto; ?>" style="max-width: 100%;">		
					<?php } ?>	
				</div>	
				<div class="col-5">
					<h5>Berita</h5>
