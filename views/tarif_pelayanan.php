...
<html lang="en">
	...
	<body>
		<div class="breadcrumbs breadcrumbs-light">
			<div class="container">
				<h1 class="pull-left">Jenis dan Tarif Pelayanan</h1>
			</div>
		</div>
		<div class="container">
			<div class="row">
				<div class="col">
					<?php foreach ($tarif as $tarif): ?>
						<h3><?php echo $tarif->judul;?></h3>
						<p><?php echo $tarif->keterangan;?></p>
						<iframe src="<?php echo base_url()."asset/".$tarif->file; ?>" style="width:600px;height:1000px"></iframe>
					<?php endforeach; ?>
				</div>	
				<div class="col-5">
					<h5>Berita</h5>
