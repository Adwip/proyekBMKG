...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			<div class="row">
				<div class="col">
					<?php foreach($musim as $musim) { ?>
						<img src="<?php echo base_url()."../File_BMKG/Iklim/Prakiraan_Musim/Prakiraan_musim/Gambar/".$musim->gambar;?>">
						<h3 class="font-weight-bold" style="margin-top: 20px;"><?php echo $musim->judul ?></h3>
						<p><?php echo $musim->teks ?></p>
						<iframe src="<?php echo base_url()."../File_BMKG/Iklim/Prakiraan_Musim/Prakiraan_musim/Dokumen/".$musim->pdf; ?>" style="width:600px;height:1000px"></iframe>
					<?php
					}
					?>
				</div>
