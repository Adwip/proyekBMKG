...
<html lang="en">
	...
	<body>
		<div class="breadcrumbs breadcrumbs-light">
			<div class="container">
				<h1 class="pull-left">TUGAS DAN FUNGSI BMKG DIY</h1>
			</div>
		</div>
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="text">
						<h5>A.	TUGAS</h5>
							<p>Melakukan tugas pemerintahan di bidang Meteorologi, Klimatologi, Kualitas Udara, dan Geofisika sesuai peraturan dan perundangan yang berlaku.</p>
						<h5>B.	TUGAS</h5>
							<ul>
								<li>Pengamatan, pengumpulan, pengolahan, penyebaran, dan analisa data meteorologi, klimatologi, kualitas udara, dan geofisika.</li>
								<li>Pelayanan informasi meteorologi, klimatologi, kualitas udara, dan geofisika.</li>
								<li>Koordinasi dengan pemerintah daerah serta institusi terkait.</li>
							</ul>
					</div>
				</div>
				<div class="col-5">
